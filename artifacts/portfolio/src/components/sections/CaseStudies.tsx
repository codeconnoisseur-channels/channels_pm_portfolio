...
const caseStudies = [
  {
    ...
    hook: "Found a 40% post-signup churn rate in PostHog Analytics, ran user interviews to understand it, and discovered that the problem was not what the team assumed it was.",
    ...
    impact: "MVP launched in January 2025. Progressive onboarding shipped and cut identity-verification drop-off by 25%. The product launched on schedule.",
